## human_description (rolling) - 2.0.2-1

The packages in the `human_description` repository were released into the `rolling` distro by running `/home/severin/.local/bin/bloom-release human_description -r rolling -t rolling` on `Wed, 01 Apr 2026 07:05:49 -0000`
...
## human_description (jazzy) - 2.0.2-1

The packages in the `human_description` repository were released into the `jazzy` distro by running `/home/severin/.local/bin/bloom-release --new-track --rosdistro jazzy --track jazzy human_description` on `Mon, 09 Mar 2026 10:48:14 -0000`
